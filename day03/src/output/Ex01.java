...
public class Ex01 {
	public static void main(String[] args) {
		...
		// System.out.println(); : 괄호안에 하나의 값을 받아서 출력한다. 출력후 한줄 내린다.
		...
		System.out.print("\n");	// \n은 줄바꿈 문자(개행문자, NewLine(=NL), lineFeed(=LF))이다
		System.out.print("B");	// 따라서 print("\n")과 println()은 같은 역할이다
		System.out.print("\r");	// \r은 커서를 줄 왼쪽 끝으로 이동시킨다 (CarrigeReturn(=cr)) --> 포괄적인 의미에서 개행과 같음
		...
		System.out.println("1" + "2");	// 12	양쪽이 문자열, 글자모양을 이어붙여준다
		...
		int num = 1234;
		String num2 = 1234 +"";
		// String이 아닌 값을 가장 쉽게(효울적인 방법은 아님) 문자열로 바꾸는 방법은
