...
public class Ex01 {
	public static void main(String[] args) {
		...
		// 내부 요소가 여러개가 있고, 그 여러개의 요소만큼 반복돌릴 수 있는 형태를
		// iterable 하다 라고 표현한다
		...
		int num2 = 1234;			// 지역변수는 갈색으로 표시
		
		Test ob = new Test();
		System.out.println(ob.n1);	// 클래스의 멤버필드는 파란색으로 표시된다
		System.out.println();
...
class Test {
	int n1 = 1010;	// 클래스 영역에서 선언되고
	int n2 = 2020;	// 클래스를 이용한 객체에서 참조가 가능한 변수 (필드)
}
