...
public class Ex06 {
	...
	static int summary(int from,int to) {	// from 부터 to까지 숫자의 합계를 구하는 함수
		int sum = 0;
	...
	// 5. 자바의 함수는 반환자료형의 값을 반드시 전환해야만 한다
	...
	//This method must return a result of type int	-> 이 함수는 int를 무조건 반환해야만 한다는 메세지
	...
	public static void main(String[] args) {
		...
		int t3 = getFee(39);	// 4000
		int t4 = getFee(40);	// 4500
		int t5 = getFee(41);	// 5000
