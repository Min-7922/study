...
//		int[] arr5 = new int[5] {1, 2, 3, 2, 1};	// 문법 틀림
		...
		// java.util.Arrays 클래스의 toString() 함수를 이용하여 변환후 출력할 수 있다
		System.out.println("arr4 : " + Arrays.toString(arr4));
		
		arr4[0] = 11;	// 배열이름에 []를 붙이고 안에 index를 적어준다
		arr4[1] = 33;	// 배열을 구성하는 여러 멤버 ㅛ소중 하나에 접근한다
		arr4[2] = 55;	// 배열은 여러 변수를 묶은 형태이기 떄문에
		arr4[3] = 77;	// 배열 내 멤버요소는 변수를 다루는 것과 동일하다
