...
class Test {
	...
	// 작성자가 임의로 생성자를 지정하면, 자동으로 생성자를 만들어주지 않는다
	Test(int num) {
		this.num = num;
...
public class Ex06 {
	public static void main(String[] args) {
		Test ob1 = new Test();	// 생성자를 아예 작성하지 않아도 기본 생성자를 호출할 수 있다
		ob1.show();
		ob1.num = 12;
		ob1.show();
 ...
 */
		// Scanner클래스는 객체를 생성하기 위해서, InputStream 혹은 String 혹은 File등을 전달해야만 한다
		// Scanner sc = new Scanner();  에러 --->  The constructor Scanner() is undefined
		// 매개 변수를 전달받지 않는 Scanner() 생성자는 정의되어 있지 않습니다
