...
class Test4 {
	...
	// 클래스를 제외한 모든 요소의 첫글자를 소문자로 작성하지만
	// static final 필드는 예외적으로 모든 글자를 대문자로 작성한다
	// 단어와 단어의 합성어인 경우는 각 단어를 구분하기 위한 방법으로 _(언더바)를 사용한다
	
	public static int getN2() {	// static 메서드는 static필드를 참조해야 한다
...
public class Ex04 {
	public static void main(String[] args) {
		...
		System.out.println();
//		he static field Test4.n2 should be accessed in a static way
//		정적 필드 n2는 정적인 방식으로 접근해야 합니다
//		static 요소는 객체마다 서로 다른 값이 아니라, 클래스 하나의 고정된 값이므로
//		[객체.요소] 형식보다는 [클래스.요소] 형식으로 접근하는 것이 올바르다
		...
		System.out.println("Test.n2 : " + Test4.n2);
		
		System.out.println(Integer.MAX_VALUE);
		// 대표적인 static final 필드
