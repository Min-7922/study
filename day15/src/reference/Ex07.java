...
public class Ex07 {
	public static void main(String[] args) {
		...
		boolean flag2 = s1.compareTo(s2)>0;	// s1 > s2일때 true
		...
		// 두개의 문자열을 비교하여 코드값을 비교하여 정수로 반환한다
		...
		// arr배열을 정렬한다. 내부요소를 a와 b라고 할 때, b에서 a를 뺀 결과가 정수이어야 정렬이 된다.
		
		// num1-num2 정수가 0보다 크면 바꿔라
		System.out.println("<sort함수이용>");
