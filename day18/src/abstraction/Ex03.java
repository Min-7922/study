package abstraction;
// 추상클래스 : 형식을 일정하게 만들기 위하여 만든다. (=형식통일)
// 예를들어, 상속받는 모든 클래스가 똑같이 메서드를 상속받아 기능만 각기 다르게 만들고 싶다고 할때 만들게 된다.
// 상속받는 클래스들이 메서드를 모두 오버라이딩 했는지 확인을 할 수 있다 (추상메서드를 모두 오버라이딩 하지 않으면 오류발생)
...
//	void function2();
	...
	// = 추상 메서드 fuction2를 포함하는 클래스 Test3는 추상클래스가 되어야 합니다
...
public class Ex03 {
	public static void main(String[] args) {
		// 실제 객체를 코드에 반영하 때는 작성자의 시점 / 관점에 따라 필요한 부분만 반영하게 된다
